...
interface ShelfAppearanceFormProps {
  user: UserProfile;
  onSuccess?: () => void;
  showCancel?: boolean;
  onCancel?: () => void;
...
export function ShelfAppearanceForm({
  user,
  onSuccess,
  showCancel = false,
  onCancel,
}: ShelfAppearanceFormProps) {
    ...
    >
      ...
      <div className="grid gap-2">
        ...
        <p className="text-xs text-stone-500">
          Target classes like <code>.shelf-header</code>, <code>.shelf-title</code>,{" "}
          <code>.shelf-stats</code>, <code>.shelf-grid</code>, and{" "}
          <code>.shelf-card</code>.
        </p>
